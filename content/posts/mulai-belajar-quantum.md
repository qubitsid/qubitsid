...
summary: "Di era dimana AI sudah sangat powerful dan komunitas tech Indonesia penuh inovasi, kenapa harus belajar quantum computing?"
---

## Konteks

Di grup WhatsApp komunitas, teman-teman sudah bikin karya yang luar biasa:
- Layanan pembuat aplikasi dengan perintah suara
- PoC RAG system yang bisa jadi dalam 30 menitan dengan bantuan AI
- Project iseng sampai project serius yang memanfaatkan AI secara maksimal

AI sudah menjadi bagian dari kehidupan. Interaksi dengan AI untuk pekerjaan dan kehidupan sehari-hari sudah jadi normal.
...
Bukan "quantum will replace everything" - itu tidak realistis. Tapi ada problem space tertentu dimana quantum approach bisa lebih efisien.
...
Resources dan code examples available di [GitHub](https://github.com/qubitsid).
